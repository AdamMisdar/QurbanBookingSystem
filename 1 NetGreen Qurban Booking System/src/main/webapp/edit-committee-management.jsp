...
<div class="content">
    <h1>KEMASKINI MAKLUMAT AKAUN (PENGURUSAN)</h1>
        ...
        <form method="post">
            ...
            <c:forEach var="management" items="${managementResult.rows}">
             ...
             %>
                ...
                <tr>
                    <th>Jawatan:</th>
                    <td><input type="text" name="managementPosition" value="${management.managementposition}"></td>
                </tr>
                </c:if>
                <c:if test="${management.managementposition != 'Pengerusi'}">
                <tr>
                    ...
                    <td>
                        <select name="managerID">
                            ...
                            <c:forEach var="res" items="${resMan.rows}">
                                <option value="${management.managerid}" selected><c:out value="${res.committeefullname}"/></option>
                            
                                <c:forEach var="manager" items="${managerRes.rows}">
                                    <c:if test="${management.managerid != res.committeeid}">
            ...
            <button name="back" class="buttoncancel" onclick="checkercancel()" formaction="CommitteeHandler?action=viewManagement&ID=<%=ID_committee%>">BATAL</button>
            <button type="submit" class="buttonsave" onclick="checkerupdate()"name="update" formaction="CommitteeHandler?action=updateManagementManagerOnly">SIMPAN</button>
         </form>
