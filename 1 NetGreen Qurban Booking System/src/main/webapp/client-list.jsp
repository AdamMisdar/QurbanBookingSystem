    ...
    <form method="post">
    	<table>
    		...
    		<tr>
    			...
    			<td>
    				<button class="button" style="background-color: #4CAF50;" name="update" formaction="ClientHandler?action=viewClient&ID=${client.clientid}">KEMASKINI</button>
					<button class="button" style="background-color: #ac2121;" name="delete" formaction="ClientHandler?action=deleteClient&ID=${client.clientid}">PADAM</button>
    			</td>
    		</tr>
    		</c:forEach>
