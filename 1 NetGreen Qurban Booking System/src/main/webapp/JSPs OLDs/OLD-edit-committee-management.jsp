...
<%----------------------------------------------------- SIDEBAR MANAGEMENT DETAILS --%>	
    ...
    <form method="post">
		...
		<button name="back" formaction="CommitteeHandler?action=viewManagement&ID=<%=ID_committee%>">BATAL</button>
		<button type="submit" name="update" formaction="CommitteeHandler?action=updateManagementManagerOnly">SIMPAN</button>
 	</form>
</body>
</html>