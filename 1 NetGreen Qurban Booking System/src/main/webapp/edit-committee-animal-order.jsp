...
<%--------------------------------------- COMMITTEE MANAGEMENT DETAILS --%>
    ...
    <div class="mobile_nav">
      ...
      <div class="mobile_nav_items">
       ...
       <% } %>
        <a href="view-committee-account.jsp" onclick="location.href='view-committee-account.jsp'"><i class="fas fa-user"></i><span>Akaun</span></a>
	...
	<form method="post">
		...
		<br><br>
		<button class="buttoncancel" name="cancel" onclick="checkercancel()" formaction="AnimalOrderHandler?action=cancelUpdateCommittee&bookingID=<%=booking_id%>">BATAL</button>
		<button class="buttonsave" type="submit" onclick="checkerupdate()" formaction="AnimalOrderHandler?action=updateAnimalOrderCommittee&bookingID=<%=booking_id%>">SIMPAN</button>
