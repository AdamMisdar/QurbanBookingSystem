...
<div class="content">
    ...
    <button name="register" class="buttonadd" onclick="checkeradd()" onclick="location.href='staff-choice.jsp'">DAFTAR AJK BARU</button>
    <br><br><br>
    ...
    <table class="content-table">
    	...
    	<tr>
    		...
    		<td>
    			<button name="update" onclick="checkerupdate()" class="buttonview" formaction="CommitteeHandler?action=viewManagement&ID=${management.committeeID}">KEMASKINI</button>
    			<c:forEach var="thisCom" items="${thisCom.rows}">
    				<c:if test="${management.committeeid != thisCom.committeeid}">
    					<c:if test="${management.managementposition != 'Pengerusi'}">
    						<button name="delete" onclick="checkerdelete()" class="buttondelete" formaction="CommitteeHandler?action=deleteManagement&ID=${management.committeeID}">PADAM</button>
    					</c:if>
    				</c:if>
    			</c:forEach>
    		</td>
    	...
    	<tr>
    		...
    		<td>
    			<button name="update" class="buttonview" onclick="checkerupdate()" formaction="CommitteeHandler?action=viewVoluntary&ID=${voluntary.committeeID}">KEMASKINI</button>
				<button name="delete" class="buttondelete" onclick="checkerdelete()" formaction="CommitteeHandler?action=deleteVoluntary&ID=${voluntary.committeeID}">PADAM</button>
    		</td>
    	</tr>
    	</c:forEach>
    </table>
...
<script>
     function checkerlogout(){
        ...
        function checkerdelete(){
            var result=confirm('Pastikah anda ingin memadam?')
            if (result==false){
                event.preventDefault();
            }
        }
        function checkeradd(){
            var result=confirm('Tambah AJK baru?')
            if (result==false){
                event.preventDefault();
            }
        }
        function checkerupdate(){
            var result=confirm('Kemaskini?')
            if (result==false){
                event.preventDefault();
            }
        }
