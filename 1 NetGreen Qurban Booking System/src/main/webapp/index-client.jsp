                ...
                <div class="collapse navbar-collapse" id="show-menu">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item active">
                            <a class="nav-link" href="index-client.jsp" onclick="location.href='index-client.jsp'">Laman Utama <span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" type="submit" href="Buat Tempahan" onclick="location.href='BookingHandler?action=createBooking&bookingDate=<%=dateToday%>&clientID=<%=client_id%>'">Buat Tempahan</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="Senarai Tempahan" onclick="location.href='client-booking-list.jsp'">Senarai Tempahan</a>
                        </li>
                       
                        <li class="nav-item">
                            <a class="nav-link" href="#" onclick="location.href='view-client-account.jsp'"><i class="far fa-user"></i> Akaun</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="Log Keluar" onclick="location.href='LoginHandler?action=logout'"><i class="fas fa-sign-out-alt"></i> Log Keluar</a>
                        </li>
            ...
            <div class="overlay">
                <div class="container">
                    <div>
                        ...
                        <button onclick="location.href='BookingHandler?action=createBooking&bookingDate=<%=dateToday%>&clientID=<%=client_id%>'"><a class="text-uppercase" style="color: white;">tempah sekarang</a></button>
                    </div>
                </div>
            </div>
        </header>
