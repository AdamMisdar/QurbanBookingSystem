...
<div class="content">
    <h1>MAKLUMAT AKAUN (SUKARELAWAN)</h1>
    ...
    <form method="post">
		...
		<button type="submit" name="update"onclick="checkerupdate()"  formaction="CommitteeHandler?action=editVoluntary&ID=<%=ID_committee%>">KEMASKINI</button>
 	</form>
    </div>
