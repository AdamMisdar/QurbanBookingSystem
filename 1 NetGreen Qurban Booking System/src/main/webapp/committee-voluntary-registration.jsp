...
<%----------------------------------------------------- MANAGER --%>
    ...
    <div class="center">
        ...
        <h1>Daftar Akaun Sukarelawan</h1>
   ...
   <%--      <p id="voluntary">Jawatan Pengurusan</p>
          <div class="select">
     ...
     --%>  
          ...
          <div class="txt_field">
            <input type="text" name="voluntaryRole" required>
            <span></span>
            <label>Bahagian Kerja:</label>
          </div>
          
          <div class="txt_field">
            <input type="text" name="hourlyRate" required>
            <span></span>
            <label>Kadar Setiap Jam:</label>
          </div>
          ...
          <input type="submit" value="Log Masuk">
             -->
             <input type="submit" id="create" class="button" name="submit" formaction="CommitteeHandler?action=createCommittee&committeeType=voluntary" onclick="wrong_pass_alert()" value="Daftar Akaun">
